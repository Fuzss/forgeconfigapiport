 ...
 * <p>
 * Methods must be called only during {@link net.minecraftforge.fml.event.lifecycle.FMLConstructModEvent}, as would be
 * done for Forge's configs. Do not call during any of the setup events.
 */
