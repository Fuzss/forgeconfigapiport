 ...
 */
public record ModConfigEventsHolderV2(String modId, Event<ModConfigEvents.Loading> loading,
     ...
     */
    public static ModConfigEventsHolderV2 modSpecific(String modId) {
        return MOD_SPECIFIC_EVENT_HOLDERS.computeIfAbsent(modId, ModConfigEventsHolderV2::create);
    }
     ...
     */
    private static ModConfigEventsHolderV2 create(String modId) {
        ...
        return new ModConfigEventsHolderV2(modId, loading, reloading, unloading);
    }
}
